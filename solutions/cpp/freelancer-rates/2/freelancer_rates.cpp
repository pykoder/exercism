...
// A freelancer works 8 hours per day.
...
// The returned monthly rate is rounded up to above integer.
int monthly_rate(double hourly_rate, double discount) {
    double monthly = daily_rate(hourly_rate) * 22;
    return static_cast<int>(apply_discount(monthly, discount) + 0.9999999);
}
